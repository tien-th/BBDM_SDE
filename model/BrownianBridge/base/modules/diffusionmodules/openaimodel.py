...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.time_embed = self.embed = nn.Sequential(GaussianFourierProjection(embed_dim=time_embed_dim),
    ...
    def forward(self, x, timesteps=None, marginal_prob_std = None, context=None, y=None,**kwargs):
        """
        ...
        if self.predict_codebook_ids:
            ...
            if marginal_prob_std is not None:
                h = self.out(h)
                h = h / marginal_prob_std(timesteps)[:, None, None, None]
                return h
            return self.out(h) 
